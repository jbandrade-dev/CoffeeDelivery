...
export function Navbar() {
  ...
  return (
    <nav className="w-full" id="home">
      <div className="flex justify-between items-center max-w-[1120px] mx-auto h-[104px] pr-2 py-8">
        ...
        <section className="flex items-center gap-2">
          ...
          <MapPin size={22} weight="fill" />
            <span className="text-sm mr-0.5">Rio de Janeiro, Rj</span>
          </div>
          ...
          <Link href="/checkout" aria-label="Página de checkout">
            ...
            <ShoppingCartSimple alt="Ícone de carrinho de compras, clique para ir para página de checkout e completar seu pedido" size={22} weight="fill" />
