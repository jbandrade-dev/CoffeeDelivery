...
export function Hero() {
  return (
    <section className="w-full pc:flex pc:justify-between mob:grid pc:max-h-[544px] pc:px-0 mob:px-6 tablet:px-6 mob:h-full tablet:h-full">
      ...
      <Image
        className="max-w-[476px] pc:order-2 mob:order-1 w-full pc:pt-24 pc:pb-24 mob:pt-6"
